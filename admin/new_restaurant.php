...
if (isset($_POST["btn_new_client"])) {
    ...
    if ($rest_time == "monday_friday") {
        ...
        $day="Monday_Friday";
        $time_sql = "insert into Client_working(Client_id,Open_time,Close_time,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday,Days) values('" . $rest_id . "','" . $rest_open . "','" . $rest_close . "',1,1,1,1,1,0,0,'".$day."')";
        ...
        $time_sql = "insert into Client_working(Client_id,Open_time,Close_time,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday,Days) values('" . $rest_id . "','" . $rest_open . "','" . $rest_close . "',0,0,0,0,0,1,1,'".$day."')";
        ...
        $day="Every_Day";
        $time_sql = "insert into Client_working(Client_id,Open_time,Close_time,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday,Days) values('" . $rest_id . "','" . $rest_open . "','" . $rest_close . "',1,1,1,1,1,1,1,'".$day."')";
                ...
                <div class="login-form">
                    <form method="POST" name="kpd">
                        ...
                        <div class="form-group">
                            ...
                            <input class="au-input" type="text" name="rest_name" placeholder="Name Of Restaurant"
                                required>
                        </div>

                        <div class="form-group">
                            <label>Restaurant Address :</label>
                            <textarea name="rest_address" rows="4" cols="50" placeholder="Address"></textarea>
                        </div>

                        <div class="form-group">
                            <label>Email :</label>
                            <input class="au-input" type="text" name="rest_email" placeholder="Enter Email-ID" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="au-input" type="text" placeholder="Mobile/Telephone Number" name="rest_number"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Vision :</label>
                            <textarea name="rest_about" rows="4" cols="50" placeholder="Client's Vision"></textarea>
                        </div>
